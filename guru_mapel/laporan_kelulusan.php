...
<body>
    <div class="container mt-5">
        <h3 class="text-center mb-4 text-gray-800">Laporan Kelulusan Siswa Mata Pelajaran</h3>
        ...
        <div class="text-center mt-3">
            <a href="guru_mapel_dashboard.php" class="btn btn-primary">Kembali ke Dashboard</a>
        </div>
    </div>
