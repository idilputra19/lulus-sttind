...
$nis = $_SESSION['username']; // Mendapatkan NIS dari session
...
<body>
    <div class="container mt-5">
        <h3 class="text-center mb-4 text-gray-800">Transkrip Nilai</h3>
        ...
        <div class="text-center">
            <button class="btn btn-primary" onclick="window.print()">Cetak Transkrip</button>
        </div>
    </div>
